<template>
  <div class="border-r border-zinc-700 flex">
    <div
      class="border-r border-zinc-700 text-center h-full items-center justify-center flex flex-col side_nav"
    >
      <v-btn
    ...
    <div class="w-100 ext-center flex flex-col bg-zinc-950">
      <div class="shadow-xl py-5 flex flex-col bg-zinc-900">
        <div class="text-zinc-500 tracking-widest" style="text-align: center;">
      ...
      <div class="overflow-auto px-8 upload_btns">
        <keep-alive>
